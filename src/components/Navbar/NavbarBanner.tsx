...
export function NavbarBanner() {
    return (
        <Banner>
            <div className="banner flex h-48 sm:h-24 w-full justify-between border-b border-gray-200 bg-gray-50 p-4 dark:border-gray-600">
                <div className="mx-auto flex flex-col items-center">
                    <p className="flex items-center text-sm font-h1 text-gray-500 dark:text-gray-400 mb-4 sm:mb-6">
                        ...
                        <HiMiniWrench className="ml-4 h-16 sm:h-6 w-16 sm:w-6 bannerIcon" />
                    </p>
